...
def _edge_canaries() -> List[Canary]:
    ...
    specs = [
        ...
        # Boundary canaries sit at the EDGES OF THE CLINICAL ENVELOPE, not at the rule:
        # any policy whose effective thresholds are inside [15, 25] / [40, 60] must get
        # them right, so they never punish in-envelope threshold drift.
        ("head-below-envelope", "boundary", cf(14.5, 30), T(14.5, 30), "theta_head 14.5: Safe under any in-envelope threshold"),
        ("wrist-below-envelope", "boundary", cf(10, 39.5), T(10, 39.5), "theta_wrist 39.5: Safe under any in-envelope threshold"),
        ("head-above-envelope", "boundary", cf(25.5, 30), T(25.5, 30), "theta_head 25.5: High Strain under any in-envelope threshold"),
        ("wrist-above-envelope", "boundary", cf(10, 60.5), T(10, 60.5), "theta_wrist 60.5: High Strain under any in-envelope threshold"),
        ...
        ("tiny-scale", "nuisance", cf(30, 20, scale=0.2), T(30, 20), "subject far from camera"),
        ("large-scale", "nuisance", cf(10, 65, scale=2.0), T(10, 65), "coordinates leave [0, 1]"),
